...
# <img src="https://raw.githubusercontent.com/redhat-developer/vscode-openshift-tools/main/images/context/cluster-node.png" width="30" height="30" /><span styles="margin: 5px">OpenShift Toolkit</span>
...
[Walkthrough Running a Demo App](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/doc/wild-west-demo-app-walkthrough.md) •
...
:::tip[Tip]
Please follow this [guide](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/README.crc-workflow.md) to understand the guided workflow to provision OpenShift locally.
:::
...
:::tip[Tip]
For more Serverless Functions Actions, please visit the detailed section [here](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/README.serverlessfn.md)
:::
...
:::tip[Tip]
For more detailed information about specific commands and dependencies, please read the [extension commands](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/README.commands.md) guide.
:::

## Release Notes

See the [change log](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/CHANGELOG.md).

## Contributing

This is an open-source project open to anyone. This project welcomes contributions and suggestions!

For information on getting started, please take a look at the [CONTRIBUTING instructions](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/CONTRIBUTING.md).
...
MIT, See [LICENSE](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/LICENSE) for more information.

## Data and telemetry

The Red Hat OpenShift Toolkit for Visual Studio Code collects anonymous [usage data](https://github.com/redhat-developer/vscode-openshift-tools/blob/main/USAGE_DATA.md) and sends it to Red Hat servers to help improve our products and services. Read our [privacy statement](https://developers.redhat.com/article/tool-data-collection) to learn more. This extension respects the `redhat.telemetry.enabled` setting which you can learn more about at https://github.com/redhat-developer/vscode-redhat-telemetry#how-to-disable-telemetry-reporting.
